...
description: |
  ...
  NOT FOR: editing specific rules (just edit directly), memory maintenance (use memory-maintenance).
...
| REINFORCED | Claude generally does this but has FAILED at it in this project (check self_review.md) | TRIM to 1-2 lines |
...
## References
- Target file: ~/telegram-claude-bot/CLAUDE.md (or whatever CLAUDE.md is in the current project)
- Self-review: ~/telegram-claude-bot/memory/self_review.md
