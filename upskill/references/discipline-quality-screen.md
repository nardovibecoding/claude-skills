...
- **PASS-INSTALL**: ≥14/17 YES, all 5 HIGH-$ checks (Q2, Q15, Q16, Q17 + any other $ marker) PASS, ≤2 NO total.
- **EXTRACT-ONLY** (write to `~/NardoWorld/atoms/extracted-patterns/<slug>-<date>.md` instead of installing): 10-13 YES, no HIGH-$ NO. Saves the IDEA without installing flawed code.
- **REJECT** (do not install, do not extract): <10 YES OR any HIGH-$ NO.
