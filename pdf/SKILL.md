...
name: pdf
description: |
  PDF read, create, merge, split, fill forms, OCR, extract, watermark, encrypt.
  Triggers: ".pdf", any PDF filename, "merge PDFs", "fill this form", "extract from PDF", "OCR this", "combine PDFs".
  NOT FOR: Word docs (docx), spreadsheets (xlsx), presentations (pptx).
  Produces: processed PDF files or extracted text/tables/images.
